...
//		stack.add(E33);
		...
		stack.add(H323);
		stack.add(H325);
//		System.out.println("hrsg_energy_in : " + hrsg_energy_in.apply(stack)); // OK
//		System.out.println("hrsg_energy_out : " + hrsg_energy_out.apply(stack)); // OK
		System.out.println("hrsg_working_fluid_energy_gain : " + hrsg_working_fluid_energy_gain.apply(stack)); // OK
//		System.out.println("hrsg_efficiency : " + hrsg_efficiency.apply(stack)); // OK
	}
	...
	private static double gtMAirCombDry(double gasFlowRate, double nitrogen, double methane, double ethane,
			...
			double gtDensity) {
		double molacularWeightFuel = molacularWeightFuel(nitrogen, methane, ethane, propane, butane, isobutane, pentane, isopentane);
	...
	private static double gtCarbonDioxide(double ambientT, double ambientP, double ambientRH, double gasFlowRate,
		...
		double molacularWeightFuel = molacularWeightFuel(nitrogen, methane, ethane, propane, butane, isobutane, pentane, isopentane);
		double gtFuelMolarFlow = gtFuelGasFlow(gasFlowRate, reynoldsNumber, gtDensity) / molacularWeightFuel;
		double gtCO2MolarFlowChange = gtFuelMolarFlow * (nitrogen * 0 + methane * 1 + ethane * 2 + propane * 3
				+ isobutane * 4 + butane * 4 + isopentane * 5 + pentane * 5);
	...
	private static double gtWater(double ambientT, double ambientP, double ambientRH, double gasFlowRate,
		...
		double molacularWeightFuel = molacularWeightFuel(nitrogen, methane, ethane, propane, butane, isobutane, pentane, isopentane);
		double gtFuelMolarFlow = gtFuelGasFlow(gasFlowRate, reynoldsNumber, gtDensity) / molacularWeightFuel;
		double gtH2OMolarFlowChange = gtFuelMolarFlow * (nitrogen * 0 + methane * 2 + ethane * 3 + propane * 4
				+ isobutane * 5 + butane * 5 + isopentane * 6 + pentane * 6);
		double gtSteamInjection = 0;
